...
// import { Github, Linkedin, Mail, MapPin, Phone, Download, Code2, Briefcase, GraduationCap } from 'lucide-react';

// // Static Site Generation
// async function getAboutData(): Promise<AboutMe | null> {
//   try {
//     const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/about`, {
//       cache: 'force-cache', // SSG for fast performance
//     });
...
//         <p className="text-white text-2xl">Unable to load profile. Please try again later.</p>
//       </div>
//     );
//   }
